...
const HomeBodyTourBox = () => {
  return (
    <section id="tourBox" className="w-1/2 mx-2 flex flex-col flex-1 justify-center items-center bg-cyan-800/80 h-fit rounded-2xl">
    ...
    <section id="origin" className="block my-3">
        ...
        <select id="" className="block bg-cyan-800 rounded-2xl p-3 text-md w-full  ">
            <option selected  >Origin of your flight</option>
    ...
    <section id="flighCategory" className="flex my-4 text-stone-200 justify-between text-xl">
        <label id="economic" ><input type="radio" name="radio" checked className="mr-2 accent-cyan-900 checked:bg-cyan-700 border-cyan-900 "/>Economic</label>
